...
server <- function(input, output, session) {
      ...
      tags$div(
        ...
        tags$div(
          ...
          tags$div(
            ...
            tags$div("Plot 1", style="border:4px solid #000; padding:6px 14px; font-weight:600;"),
            tags$div("Plot 2", style="border:4px solid #000; padding:6px 14px; font-weight:600;"),
            tags$div("Plot 3", style="border:4px solid #000; padding:6px 14px; font-weight:600;"),
            tags$div("Plot 4", style="border:4px solid #000; padding:6px 14px; font-weight:600;")
          ),
          tags$div(
  ...
  # Downloads (define each output separately)
  ...
  output$plot_main <- renderPlot({
    plot(pressure ~ temperature, data = cars,
         main = "Placeholder – add your analysis later")
  })
}
